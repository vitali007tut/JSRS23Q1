		...
		for (let element of pets) {
			if (element['name'] === petName) {
				...
				<div class="text-contant">
						<h3>${element.name}</h3>
						<p class="breed">${element.type} - ${element.breed}</p>
						<p class="desc">${element.description}</p>
					<ul>
						<li><b>Age: </b>${element.age}</li>
						<li><b>Inoculations: </b>${element.inoculations}</li>
						<li><b>diseases: </b>${element.diseases}</li>
						<li><b>parasites: </b>${element.parasites}</li>
					</ul>
					<img class="close-btn" src="./img/modal_close_button.svg" alt="">
				</div>
